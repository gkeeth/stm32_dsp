/*
 * Example 4.7b: IIR filter with cascaded second-order DF1 sections, using
 * CMSIS arm_biquad_cascade_df1_f32(). Input is shifted deltas and response
 * buffer can be dumped with gdb and plotted.
 *
